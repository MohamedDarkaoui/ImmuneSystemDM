...
from src.external.bio.peptide_feature import Charge, Hydrophobicity, IsoelectricPoint
from src.external.definitions.amino_acid_properties import AMINO_ACIDS
