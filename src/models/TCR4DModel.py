...
class TCR4DModel(AbstractModel):
    """
    This model subclass is meant for training on 4D data
    """
    ...
    def max_pool(self):
        return keras.layers.MaxPool3D(pool_size=self.pool_size)

    def spacial_dropout(self):
        return keras.layers.SpatialDropout3D(self.dropout_rate)
